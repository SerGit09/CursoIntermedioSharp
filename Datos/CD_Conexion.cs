...
namespace Datos
{
    public class CD_Conexion
    {
        ...
        public  SqlConnection CrearConexion()
        {
            ...
            try
            {
                //Conexion.ConnectionString = "Server=" + this.Servidor + "; Database=" + this.Bd + ";Integrated Security=true";
                Conexion = new SqlConnection("data source=192.168.0.17,1433;initial catalog=MiBaseDatos; user id=user1;password=1234;");
